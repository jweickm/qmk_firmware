...
//  {.key = B_SHFT|B_U               , .kana = "mo"      }, // も
  {.key = B_SHFT|B_U               , .kana = "e"      }, // え
  {.key = B_U                      , .kana = "sa"      }, // さ
...
//  {.key = B_A                      , .kana = "ro"      }, // ろ
  {.key = B_SHFT|B_N                      , .kana = "ro"      }, // ろ
//  {.key = B_SHFT|B_L               , .kana = "wa"      }, // わ
  {.key = B_SHFT|B_I               , .kana = "wa"      }, // わ
  {.key = B_SHFT|B_C               , .kana = "wo"      }, // を
  {.key = B_COMM                   , .kana = "nn"      }, // ん
//  {.key = B_SCLN                   , .kana = "-"       }, // ー
  {.key = B_SHFT|B_J                   , .kana = "-"       }, // ー
...
//  {.key = B_V|B_SLSH|B_N           , .kana = "fo"      }, // ふぉ
  {.key = B_V|B_DOT|B_SCLN            , .kana = "fo"      }, // ふぉ
  {.key = B_V|B_SLSH|B_SCLN           , .kana = "fo"      }, // ふぉ
...
//  {.key = B_V|B_L|B_K              , .kana = "wi"      }, // うぃ
  {.key = B_V|B_I|B_L              , .kana = "wi"      }, // うぃ
//  {.key = B_V|B_L|B_O              , .kana = "we"      }, // うぇ
  {.key = B_V|B_I|B_U              , .kana = "we"      }, // うぇ
//  {.key = B_V|B_L|B_N              , .kana = "uxo"     }, // うぉ
//  {.key = B_V|B_I|B_N              , .kana = "uxo"     }, // うぉ
  {.key = B_V|B_I|B_SCLN              , .kana = "uxo"     }, // うぉ
//  {.key = B_F|B_L|B_J              , .kana = "va"      }, // ゔぁ
//  {.key = B_F|B_I|B_J              , .kana = "va"      }, // ゔぁ
  {.key = B_F|B_I|B_A              , .kana = "va"      }, // ゔぁ
//  {.key = B_F|B_L|B_K              , .kana = "vi"      }, // ゔぃ
  {.key = B_F|B_I|B_L              , .kana = "vi"      }, // ゔぃ
//  {.key = B_F|B_L|B_O              , .kana = "ve"      }, // ゔぇ
  {.key = B_F|B_I|B_U              , .kana = "ve"      }, // ゔぇ
//  {.key = B_F|B_L|B_N              , .kana = "vo"      }, // ゔぉ
//  {.key = B_F|B_I|B_N              , .kana = "vo"      }, // ゔぉ
  {.key = B_F|B_I|B_SCLN              , .kana = "vo"      }, // ゔぉ
//  {.key = B_F|B_L|B_P              , .kana = "vuxyu"   }, // ゔゅ
  {.key = B_F|B_I|B_O              , .kana = "vuxyu"   }, // ゔゅ
//  {.key = B_V|B_H|B_J              , .kana = "kuxa"    }, // くぁ
  {.key = B_V|B_H|B_A              , .kana = "kuxa"    }, // くぁ
//  {.key = B_V|B_H|B_K              , .kana = "kuxi"    }, // くぃ
  {.key = B_V|B_H|B_L              , .kana = "kuxi"    }, // くぃ
//  {.key = B_V|B_H|B_O              , .kana = "kuxe"    }, // くぇ
  {.key = B_V|B_H|B_U              , .kana = "kuxe"    }, // くぇ
//  {.key = B_V|B_H|B_N              , .kana = "kuxo"    }, // くぉ
  {.key = B_V|B_H|B_SCLN              , .kana = "kuxo"    }, // くぉ
  {.key = B_V|B_H|B_I              , .kana = "kuxwa"   }, // くゎ
//  {.key = B_F|B_H|B_J              , .kana = "guxa"    }, // ぐぁ
  {.key = B_F|B_H|B_A              , .kana = "guxa"    }, // ぐぁ
//  {.key = B_F|B_H|B_K              , .kana = "guxi"    }, // ぐぃ
  {.key = B_F|B_H|B_L              , .kana = "guxi"    }, // ぐぃ
//  {.key = B_F|B_H|B_O              , .kana = "guxe"    }, // ぐぇ
  {.key = B_F|B_H|B_U              , .kana = "guxe"    }, // ぐぇ
//  {.key = B_F|B_H|B_N              , .kana = "guxo"    }, // ぐぉ
  {.key = B_F|B_H|B_SCLN              , .kana = "guxo"    }, // ぐぉ
  {.key = B_F|B_H|B_I              , .kana = "guxwa"   }, // ぐゎ
//  {.key = B_V|B_SCLN|B_J           , .kana = "tsa"     }, // つぁ
  {.key = B_V|B_SCLN|B_A           , .kana = "tsa"     }, // つぁ
//  {.key = B_V|B_SCLN|B_K           , .kana = "tsi"     }, // つぃ
  {.key = B_V|B_SCLN|B_L           , .kana = "tsi"     }, // つぃ
//  {.key = B_V|B_SCLN|B_O           , .kana = "tse"     }, // つぇ
  {.key = B_V|B_SCLN|B_U           , .kana = "tse"     }, // つぇ
...
//  {.key = B_SHFT|B_V|B_M    , .kana = SS_TAP(X_ENTER)},
  ...
  // backspace
  {.key = B_V|B_M           , .kana = SS_TAP(X_BSPC)},
  // backspace+シフト(連続シフト)
  {.key = B_SHFT|B_V|B_M    , .kana = SS_TAP(X_BSPC)},
...
//  // {.key = B_J|B_K|B_S		, .kana = ""}, // (){改行}{↑}
//  {.key = B_J|B_K|B_D		, .kana = "?"SS_TAP(X_ENTER)}, // ？{改行}
//  // {.key = B_J|B_K|B_F		, .kana = ""}, // 「」{改行}{↑}
//  // {.key = B_J|B_K|B_G		, .kana = ""}, // {改行}{End}{改行}「」{改行}{↑}
...
////{.key = B_D|B_F|B_SCLN		, .kana = SS_LSFT(SS_TAP(NGUP)SS_TAP(NGUP)SS_TAP(NGUP)SS_TAP(NGUP)SS_TAP(NGUP))}, // +{↑ 5}
...
////{.key = B_D|B_F|B_SLSH		, .kana = SS_LSFT(SS_TAP(NGDN)SS_TAP(NGDN)SS_TAP(NGDN)SS_TAP(NGDN)SS_TAP(NGDN))}, // +{↓ 5}
////{.key = B_M|B_COMM|B_Q		, .macro , // 　　　×　　　×　　　×{改行 2}
...
//  {.key = B_C|B_V|B_O		, .kana = SS_LCTL("u")}, // ^u
//  {.key = B_C|B_V|B_P		, .kana = SS_LCTL("i")}, // ^i
//  {.key = B_C|B_V|B_H		, .kana = SS_LCTL("c")}, // ^c
////{.key = B_C|B_V|B_J		, .kana = SS_TAP(NGRT)}, // {→}
////{.key = B_C|B_V|B_K		, .kana = SS_LSFT(SS_TAP(NGRT))}, // +{→}
////{.key = B_C|B_V|B_L		, .kana = SS_TAP(NGRT)SS_TAP(NGRT)SS_TAP(NGRT)SS_TAP(NGRT)SS_TAP(NGRT)}, // {→ 5}
////{.key = B_C|B_V|B_SCLN		, .kana = SS_LSFT(SS_TAP(NGRT)SS_TAP(NGRT)SS_TAP(NGRT)SS_TAP(NGRT)SS_TAP(NGRT))}, // +{→ 5}
//  {.key = B_C|B_V|B_N		, .kana = SS_LSFT(SS_TAP(X_END))}, // +{End}
////{.key = B_C|B_V|B_M		, .kana = SS_TAP(NGLT)}, // {←}
...
//// 編集モード 縦横
//  {.key = B_D|B_F|B_J		, .kana = SS_TAP(NGDN)}, // {↓}
//  {.key = B_D|B_F|B_K		, .kana = SS_TAP(NGUP)}, // +{↑}
//// {.key = B_D|B_F|B_L		, .kana = SS_TAP(NGUP)SS_TAP(NGUP)SS_TAP(NGUP)SS_TAP(NGUP)SS_TAP(NGUP)}, // {↑ 5}
//  {.key = B_D|B_F|B_L		, .kana = SS_TAP(NGRT)}, // {->}
//  {.key = B_D|B_F|B_SCLN		, .kana = SS_LSFT(SS_TAP(NGUP)SS_TAP(NGUP)SS_TAP(NGUP)SS_TAP(NGUP)SS_TAP(NGUP))}, // +{↑ 5}
//  {.key = B_D|B_F|B_M		, .kana = SS_LSFT(SS_TAP(NGDN))}, // +{↓}
//  {.key = B_D|B_F|B_COMM		, .kana = SS_LSFT(SS_TAP(NGUP))}, // +{↑}
//  {.key = B_D|B_F|B_DOT		, .kana = SS_TAP(NGDN)SS_TAP(NGDN)SS_TAP(NGDN)SS_TAP(NGDN)SS_TAP(NGDN)}, // {↓ 5}
//  {.key = B_D|B_F|B_SLSH		, .kana = SS_LSFT(SS_TAP(NGDN)SS_TAP(NGDN)SS_TAP(NGDN)SS_TAP(NGDN)SS_TAP(NGDN))}, // +{↓ 5}
//  {.key = B_D|B_F|B_H		, .kana = SS_TAP(NGLT)}, // {<-}
//  {.key = B_C|B_V|B_J		, .kana = SS_TAP(NGRT)}, // {→}
...
static naginata_keymap_long ngmapl_ty[2];
...
void naginata_on(void) {
  ...
  tap_code(KC_LANG1); // Mac (also required for windows)
...
void naginata_off(void) {
  ...
  tap_code(KC_LANG2); // Mac (also required for windows)
