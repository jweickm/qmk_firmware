// This is a backup of the original naginata_v14.c
...
//  {.key = B_V|B_SCLN|B_O           , .kana = "tse"     }, // つぇ
  {.key = B_V|B_SCLN|B_K           , .kana = "tse"     }, // つぇ
