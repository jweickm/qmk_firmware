...
* _COLEMAK
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | LCTL | LALT | LGUI | TAB  |LOWER |   NAV-SPC   | RAISE|  DEL |  APP |  FN  |  ENT | 1x2uC
     * `-----------------------------------------------------------------------------------'
     */
    [_COLEMAK] = LAYOUT_planck_mit(
        ...
        OSM(MOD_LSFT), Z_KEY, X_KEY, C_KEY, D_KEY, V_KEY, K_KEY, H_KEY, COMM_KEY, DOT_KEY, SLSH_KEY, OSM(MOD_RSFT),
        KC_LCTL, KC_LALT, KC_LGUI, TAB_KEY, LOWER,   NAVSPACE   , RAISE, DEL_KEY, RALT_KEY, FN_KEY, ENT_KEY
    ),
...
* _COLEMAK_DE
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |  CTL |  ALT |   G  | RAISE|     SPC     | ____ | ____ | ____ | ____ | GAME | ____ |
     * `-----------------------------------------------------------------------------------'
     */
...
* _UMLAUTS
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | ____ |   ß  |GC(<-)|WHL ↑ |WHL ↓ |GC(->)| HOME | PgDn | PgUp |  END | CTRL | ____ |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | ____ | ____ | ____ | ____ | ____ |     ____    | ____ | ____ | ____ | ____ | ____ | 2x2uC
     * `-----------------------------------------------------------------------------------'
     */
    [_UMLAUTS] = LAYOUT_planck_mit(
        _______, _______, _______, _______, _______, _______, _______, _______, UE_KEY, _______, OE_KEY, UE_KEY,
        _______, AE_KEY, _______,  SZ_KEY, _______, _______, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, OE_KEY, AE_KEY,
        _______, SZ_KEY, G(C(KC_LEFT)), KC_WH_U, KC_WH_D, G(C(KC_RIGHT)), KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_LCTL, _______,
...
* _NUM
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | ____ | ____ | ____ |   -  | ____ |    ____     |   0  |   .  |   ,  |   =  | ____ | 1x2uC
     * `-----------------------------------------------------------------------------------'
     */
    [_NUM] = LAYOUT_planck_mit(
        ...
        _______, _______, _______, KC_KP_MINUS,  _______, _______, KC_KP_0,   DOT_KEY, COMM_KEY, KC_KP_EQUAL, _______
    ),
...
* _RAISE
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | ____ | ____ | ____ | ____ | ____ |    ____     | ____ | BRID | BRIU | ____ | ____ | 1x2uC
     * `-----------------------------------------------------------------------------------'
     */
    [_RAISE] = LAYOUT_planck_mit(
        ...
        _______, _______, KC_APP, KC_BSPC, _______, _______, _______, KC_BRID, KC_BRIU, _______, _______
    ),
...
* _MOUSE
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | ____ |WHL <-| M <- | M ↓  | M -> |WHL ->| MUTE | LCTL | RSFT | LALT | RGUI |SCRLCK|
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | ____ | LSFT |DESK<-|WHL ↑ |WHL ↓ |DESK->| MMIC |  F22 | BTN4 | BTN5 | RSFT | ____ |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | ____ | ____ | BTN4 | BTN3 | BTN2 |    BTN1     | BTN2 | BTN5 | LLOCK| ____ | ____ | 1x2uC
     * `-----------------------------------------------------------------------------------'
     */
    [_MOUSE] = LAYOUT_planck_mit(
        _______, C(KC_HOME), KC_BTN4, KC_MS_U, KC_BTN5, C(KC_END), KC_F16, KC_F17, KC_F18, KC_F19, KC_F20, KC_F21,
        _______, KC_WH_L, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_R, KC_MUTE, KC_LCTL, OSM(MOD_RSFT), OSM(MOD_LALT), OSM(MOD_RGUI), KC_SCROLL_LOCK,
        _______, KC_LSFT, C(G(KC_LEFT)), KC_WH_U, KC_WH_D, C(G(KC_RIGHT)), KC_MMIC, KC_F22, KC_BTN4, KC_BTN5, KC_RSFT, _______,
        _______, _______, KC_BTN4, KC_BTN3, KC_BTN2, KC_BTN1, KC_BTN2, KC_BTN5, LLOCK, _______, _______
    ),

/* ----------------------------------------------------------------------------------------
* _ADJUST
     * ,-----------------------------------------------------------------------------------.
     * |A(TAB)| ____ | C(->)|  INS | PSCR | C(<-)| KANA | REDO | UNDO | LANG |KBLANG|  INS |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |C(ALT)| LGUI | LALT | LSFT | LCTL |  GAC | LEFT | DOWN |  UP  | RIGHT| VIM_O| CAPS |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | LSFT |NUMLCK|DESK<-| WHLUP| WHLDN|DESK->| HOME | PGDN | PGUP |  END | ____ | ____ |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |EEPRST| FLASH| ____ | ____ | ____ |     ____    | ____ | VOL- | VOL+ | GAME |  AFK | 1x2uC
     * `-----------------------------------------------------------------------------------'
     */
    [_ADJUST] = LAYOUT_planck_mit(
        ...
        QK_CLEAR_EEPROM, QK_BOOT, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, TG(_GAMING), KC_AFK
    ),
