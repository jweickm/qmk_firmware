...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |   Z  |   X  |   C  |   D  |   V  |   ↓  |   ↑  |   K  |   H  |  ,<  |  .>  |  /?  |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | LCTL | LALT |  TAB | LOWER|  \|  |     SPC     |  =+  | RAISE|  DEL | APPFN|  GUI | 
     * `-----------------------------------------------------------------------------------'
     */
    ...
    [_RAISE] = LAYOUT_planck_mit(
        ...
        LGUI_T(KC_F1), LALT_T(KC_F2), LSFT_T(KC_F3), LCTL_T(KC_F4),  KC_F5,  KC_F6,   _______, KC_LABK, KC_MINS, KC_PERC, KC_LBRC, KC_RBRC, 
    ...
    [_RAISE_DE] = LAYOUT_planck_mit(
        KC_1,  KC_2,  KC_3,  KC_4,   KC_5,   _______, _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    
        LGUI_T(KC_F1), LALT_T(KC_F2), LSFT_T(KC_F3), LCTL_T(KC_F4),  KC_F5,  KC_F6,   _______, DE_LABK, DE_MINS, DE_PERC, DE_LBRC, DE_RBRC, 
