...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |   Ä  | ____ |   ß  | ____ | ____ | ____ | ____ | ____ | ____ | ____ | ____ |   Ö  |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
    ...
    [_UMLAUTS] = LAYOUT_planck_mit(
        ...
        AE_KEY, _______, SZ_KEY, _______, _______, _______, _______, _______, _______, _______, _______, OE_KEY,
    ...
    [_RAISE] = LAYOUT_planck_mit(
        ...
        KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,  _______, KC_RABK, KC_TILD, KC_COMM, KC_DOT, KC_SLSH, 
    ...
    [_RAISE_DE] = LAYOUT_planck_mit(
        ...
        KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,  _______, DE_RABK, DE_TILD, DE_COMM, DE_DOT, DE_SLSH, 
