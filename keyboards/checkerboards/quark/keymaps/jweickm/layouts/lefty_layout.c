...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAK] = LAYOUT_planck_mit(
        Q_KEY, W_KEY, F_KEY, P_KEY, B_KEY, J_KEY, L_KEY, U_KEY, Y_KEY, SCLN_KEY, BSLS_KEY, KC_ESC,
        A_KEY, R_KEY, S_KEY, T_KEY, G_KEY, M_KEY, N_KEY, E_KEY,    I_KEY,   O_KEY, QUOT_KEY, KC_TAB,
     ...
     * ,-----------------------------------------------------------------------------------.
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | ____ | ____ | ____ | ____ | ____ | ____ | ____ |   Ü  | ____ |   Ä  | ____ | ____ |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |   Ä  | ____ |   ß  | ____ | ____ |  <-  |   ↓  |   ↑  |  ->  |   Ö  | ____ | ____ |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
    ...
    [_UMLAUTS] = LAYOUT_planck_mit(
        ...
        SZ_KEY,  _______, _______, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_LCTL,
     ...
     * _RAISE
     * ,-----------------------------------------------------------------------------------.
     * |  F1  |  F2  |  F3  |  F4  |   `  |   6  |   7  |   8  |   9  |   0  |   \  | ____ |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |  F5  |  F6  |  F7  |  F8  | ____ |   <  |   -  |   =  |   [  |   ]  |   '  | ____ |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |  F9  |  F10 |  F11 |  F12 | ____ |   >  |   ~  |   ,  |   .  |   \  | ____ | ____ |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | ____ | ____ |  SPC | ____ | ____ |     ____    | ____ | ____ | ____ | ____ | ____ | 
     * `-----------------------------------------------------------------------------------'
     */
    [_RAISE] = LAYOUT_planck_mit(
        KC_F1,  KC_F2,  KC_F3,  KC_F4,   _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0, _______, _______, 
        LGUI_T(KC_F5), LALT_T(KC_F6), LSFT_T(KC_F7), LCTL_T(KC_F8),  KC_F5,  KC_F6,   _______, KC_LABK, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, 
        KC_F9, KC_F10, KC_F11, KC_F12, KC_F11, KC_F12,  _______, KC_RABK, KC_TILD, KC_COMM, KC_DOT, KC_BSLS, 
        _______, _______, KC_SPC, _______, _______, _______, _______, _______, _______, _______, _______
        ),
     ...
     * _MOUSE
     * ,-----------------------------------------------------------------------------------.
     * |  ESC | BTN4 | M ↑  | BTN5 |  F13 |  F16 |  F17 |  F18 |  F19 |  F20 |  F14 |  F15 |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |WHL <-| M <- | M ↓  | M -> |WHL ->|  F21 | LCTL | RSFT | LALT | RGUI | NUM  | MUTE |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | LSFT |DESK<-|WHL ↑ |WHL ↓ |DESK->|  F22 |  F23 | BTN4 | BTN5 | RSFT | SCRL | MMIC |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | ____ | ____ | BTN 3| BTN 2| BTN 1|    _____    | RSFT | LCTL | LLOCK| ____ | ____ |
     * `-----------------------------------------------------------------------------------'
     */
    [_MOUSE] = LAYOUT_planck_mit(
        KC_ESC, KC_BTN4, KC_MS_U, KC_BTN5, KC_F13, KC_F14, KC_F15, KC_F16, KC_F17, KC_F18, KC_F19, KC_F20, 
        KC_WH_L, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_R, KC_NUM_LOCK, KC_MUTE, KC_F21, KC_LCTL, KC_RSFT, KC_LALT, KC_RGUI, 
        KC_LSFT, C(G(KC_LEFT)), KC_WH_U, KC_WH_D, C(G(KC_RIGHT)), KC_SCROLL_LOCK, KC_MMIC, KC_F22, KC_F23, KC_BTN4, KC_BTN5, KC_RSFT,
        _______, _______, KC_BTN3, KC_BTN2, KC_BTN1, _______, KC_RSFT, KC_LCTL, LLOCK, _______, _______
        ),

    /* ----------------------------------------------------------------------------------------
     * _ADJUST
     * ,-----------------------------------------------------------------------------------.
     * |A(TAB)| C(->)|  INS | PSCR | C(<-)| KANA | REDO | UNDO | LANG |KBLANG| VOL- | VOL+ |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | LGUI | LALT | LSFT | LCTL |C-END | LEFT | DOWN |  UP  | RIGHT| VIM_O| BRI- | BRI+ |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | LSFT |DESK<-| WHLUP| WHLDN|DESK->| HOME | PGDN | PGUP |  END | CAPS | MUTE | MMIC |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
