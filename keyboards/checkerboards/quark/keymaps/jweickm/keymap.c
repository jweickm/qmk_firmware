...
* _ADJUST
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |NAVSFT|NUMLCK|DESK<-| WHLUP| WHLDN|DESK->| HOME | PGDN | PGUP |  END | XXXX | MPLY |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
    ...
    [_ADJUST] = LAYOUT_planck_mit(
        ...
        NAVSFT, KC_NUM_LOCK, C(G(KC_LEFT)), KC_WH_U, KC_WH_D, C(G(KC_RIGHT)), KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_NO, KC_MPLY,
