...
/*             /1* register_code16(long_press_keycode); *1/ */
/*         /1* } else { *1/ */
/*             /1* unregister_code16(long_press_keycode); *1/ */
/*         } */
...
/* // ------------------------ SPECIAL FUNCTION KEYS ------------------------------------ */
    ...
    /*         return false; */
    /*     /1* case LOWER: *1/ */
    /*     /1*     if (record->tap.count && record->event.pressed) { *1/ */
    /*     /1*         if (osmod_state & MOD_MASK_SHIFT) { *1/ */
    /*     /1*             clear_oneshot_mods(); *1/ */
    /*     /1*         } else { *1/ */
    /*     /1*             set_oneshot_mods(MOD_BIT(KC_LSFT)); *1/ */
    /*     /1*         } *1/ */
    /*     /1*         return false; *1/ */
    /*     /1*     } *1/ */
    /*     /1*     return true; *1/ */
    ...
    /*     /1*             clear_oneshot_mods(); *1/ */
    /*     /1*         } else { *1/ */
    /*     /1*             set_oneshot_mods(MOD_BIT(KC_RSFT)); *1/ */
    /*     /1*         } *1/ */
    /*     /1*         return false; *1/ */
    /*     /1*     } *1/ */
    /*     /1*     return true; *1/ */
