...
* _LOWER
    ...
    [_LOWER] = LAYOUT_planck_mit(
        ...
        KC_TRNS, CTL_TAB, KC_HOME, KC_PGUP, KC_PGDN, KC_END, KC_TILD, QUOT_KEY, TD(TD_LARROW), TD(TD_RARROW), KC_BSLS, DE_ACC_GRV, 
...
* _MOUSE
     * ,-----------------------------------------------------------------------------------.
     * | LLOCK| !MSE |WHL <-| M ↑  |WHL ->|C-HOME| XXXX | STOP | PLY1 | REC1 | PLY2 | REC2 |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
    ...
    [_MOUSE] = LAYOUT_planck_mit(
        LLOCK, TG(_MOUSE), KC_WH_L, KC_MS_U, KC_WH_R, C(KC_HOME), KC_NO, DM_RSTP, DM_PLY1, DM_REC1, DM_PLY2, DM_REC2,
