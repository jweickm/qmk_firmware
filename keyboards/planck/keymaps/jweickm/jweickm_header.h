...
//const uint16_t PROGMEM nraise_combo[]       = {KC_N, LT(_RAISE, KC_SPC), COMBO_END};
//const uint16_t PROGMEM nraise_de_combo[]    = {KC_N, LT(_RAISE_DE, KC_SPC), COMBO_END};
...
const uint16_t PROGMEM qraise_combo[]       = {LGUI_T(KC_Q), LT(_RAISE, KC_SPC), COMBO_END};
const uint16_t PROGMEM wraise_combo[]       = {LALT_T(KC_W), LT(_RAISE, KC_SPC), COMBO_END};
const uint16_t PROGMEM fraise_combo[]       = {LSFT_T(KC_F), LT(_RAISE, KC_SPC), COMBO_END};
const uint16_t PROGMEM praise_combo[]       = {LCTL_T(KC_P), LT(_RAISE, KC_SPC), COMBO_END};
const uint16_t PROGMEM braise_combo[]       = {LT(_NUM, KC_B), LT(_RAISE, KC_SPC), COMBO_END};
const uint16_t PROGMEM volraise_combo[]     = {LT(_MOUSE, KC_VOLU), LT(_RAISE, KC_SPC), COMBO_END};
const uint16_t PROGMEM jraise_combo[]       = {LT(_NUM, KC_J), LT(_RAISE, KC_SPC), COMBO_END};
const uint16_t PROGMEM lraise_combo[]       = {RCTL_T(KC_L), LT(_RAISE, KC_SPC), COMBO_END};
const uint16_t PROGMEM uraise_combo[]       = {RSFT_T(KC_U), LT(_RAISE, KC_SPC), COMBO_END};
const uint16_t PROGMEM yraise_combo[]       = {LALT_T(KC_Y), LT(_RAISE, KC_SPC), COMBO_END};
const uint16_t PROGMEM sclnraise_combo[]    = {RGUI_T(KC_SCLN), LT(_RAISE, KC_SPC), COMBO_END};
const uint16_t PROGMEM ueraise_combo[]      = {XP(DE_ue, DE_UE), LT(_RAISE, KC_SPC), COMBO_END};

const uint16_t PROGMEM mraise_combo[]       = {KC_M, LT(_RAISE, KC_SPC), COMBO_END};
const uint16_t PROGMEM nraise_combo[]       = {KC_N, LT(_RAISE, KC_SPC), COMBO_END};
const uint16_t PROGMEM eraise_combo[]       = {KC_E, LT(_RAISE, KC_SPC), COMBO_END};
const uint16_t PROGMEM iraise_combo[]       = {KC_I, LT(_RAISE, KC_SPC), COMBO_END};
const uint16_t PROGMEM oraise_combo[]       = {KC_O, LT(_RAISE, KC_SPC), COMBO_END};
const uint16_t PROGMEM quotraise_combo[]    = {KC_QUOT, LT(_RAISE, KC_SPC), COMBO_END};
...
const uint16_t PROGMEM qraise_de_combo[]       = {LGUI_T(KC_Q), LT(_RAISE_DE, KC_SPC), COMBO_END};
const uint16_t PROGMEM wraise_de_combo[]       = {LALT_T(KC_W), LT(_RAISE_DE, KC_SPC), COMBO_END};
const uint16_t PROGMEM fraise_de_combo[]       = {LSFT_T(KC_F), LT(_RAISE_DE, KC_SPC), COMBO_END};
const uint16_t PROGMEM praise_de_combo[]       = {LCTL_T(KC_P), LT(_RAISE_DE, KC_SPC), COMBO_END};
const uint16_t PROGMEM volraise_de_combo[]     = {LT(_MOUSE, KC_VOLU), LT(_RAISE_DE, KC_SPC), COMBO_END};
const uint16_t PROGMEM braise_de_combo[]       = {LT(_NUM, KC_B), LT(_RAISE_DE, KC_SPC), COMBO_END};
const uint16_t PROGMEM jraise_de_combo[]       = {LT(_NUM, KC_J), LT(_RAISE_DE, KC_SPC), COMBO_END};
const uint16_t PROGMEM lraise_de_combo[]       = {RCTL_T(KC_L), LT(_RAISE_DE, KC_SPC), COMBO_END};
const uint16_t PROGMEM uraise_de_combo[]       = {RSFT_T(KC_U), LT(_RAISE_DE, KC_SPC), COMBO_END};
const uint16_t PROGMEM yraise_de_combo[]       = {LALT_T(KC_Z), LT(_RAISE_DE, KC_SPC), COMBO_END};
const uint16_t PROGMEM sclnraise_de_combo[]    = {M_RGUI_SCLN, LT(_RAISE_DE, KC_SPC), COMBO_END};
const uint16_t PROGMEM ueraise_de_combo[]      = {DE_UDIA, LT(_RAISE_DE, KC_SPC), COMBO_END};

const uint16_t PROGMEM mraise_de_combo[]       = {KC_M, LT(_RAISE_DE, KC_SPC), COMBO_END};
const uint16_t PROGMEM nraise_de_combo[]       = {KC_N, LT(_RAISE_DE, KC_SPC), COMBO_END};
const uint16_t PROGMEM eraise_de_combo[]       = {KC_E, LT(_RAISE_DE, KC_SPC), COMBO_END};
const uint16_t PROGMEM iraise_de_combo[]       = {KC_I, LT(_RAISE_DE, KC_SPC), COMBO_END};
const uint16_t PROGMEM oraise_de_combo[]       = {KC_O, LT(_RAISE_DE, KC_SPC), COMBO_END};
const uint16_t PROGMEM quotraise_de_combo[]    = {DE_EN_QUOT, LT(_RAISE_DE, KC_SPC), COMBO_END};
#ifdef NAGINATA_ENABLE
