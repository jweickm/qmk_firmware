...
/* _COLEMAK
    ...
    [_COLEMAK] = LAYOUT_planck_grid(
        ...
        LT(0, KC_Z), CUT_X, COPY_C, KC_D, PASTE_V, LT(_MOUSE, KC_VOLD), KC_K, KC_H, LT(0, KC_COMM), LT(0, KC_DOT), LT(0, KC_SLSH), KC_LEAD, 
    #if layout == 1
...
* _LOWER
     ...
     * |   !  |   @  |   #  |   $  |   %  |   ~  |   ^  |   &  |   *  |   (  |   )  |   Ö  |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |ALTTAB| LALT |   ß  | LSTF | XXXX | XXXX |   ß  |   _  |   +  |   {  |   }  |   Ä  |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
    ...
    [_LOWER] = LAYOUT_planck_grid(
        ...
        ALT_TAB, KC_LALT, X(DE_SZ), KC_LSFT, KC_NO, KC_NO, X(DE_SZ), KC_UNDS, KC_PLUS, TD(TD_CBR), KC_RCBR, X(DE_AE), 
