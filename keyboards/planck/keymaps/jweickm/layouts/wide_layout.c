...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAK] = LAYOUT_planck_mit(
        ...
        KC_LCTL, ESC_KEY, TAB_KEY, LOWER, OSM(MOD_LSFT), NAVSPACE, REPEAT, RAISE, DEL_KEY, ENT_KEY, KC_BSLS
        ),
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | ____ | ____ | ____ |  NAV | LOWER|     SPC     | ____ | ____ | ____ | ____ | ____ | 
     * `-----------------------------------------------------------------------------------'
     */
    [_RAISE] = LAYOUT_planck_mit(
        ...
        _______, _______, _______, ADJUST, LOWER, KC_SPC, _______, _______, _______, _______, _______
        ),
    ...
    [_RAISE_DE] = LAYOUT_planck_mit(
        ...
        _______, _______, _______, ADJUST, LOWER_DE, KC_SPC, _______, _______, _______, _______, _______
    ),
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | ____ | ____ | ____ | ____ | ____ |     SPC     | ____ |  NAV | ____ | ____ | ____ | 
     * `-----------------------------------------------------------------------------------'
     */
    [_LOWER] = LAYOUT_planck_mit(
        ...
        _______, _______, _______, _______, _______, KC_SPC, _______, ADJUST, _______, _______, _______
        ),
