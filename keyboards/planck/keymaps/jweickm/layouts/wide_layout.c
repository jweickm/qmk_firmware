...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |   Z  |   X  |   C  |   D  |   V  |   ↓  |   ↑  |   K  |   H  |  ,<  |  .>  |  /?  |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | LCTL | LALT |  TAB | LOWER|  [{  |     GUI     |   ]} | RAISE|  DEL | APPFN|  ENT | 
     * `-----------------------------------------------------------------------------------'
     */
    [_COLEMAK] = LAYOUT_planck_mit(
        ...
        KC_LCTL, KC_LALT, TAB_KEY, LOWER, LTHUMB, NAVGUI, RTHUMB, RAISE, DEL_KEY, FN_KEY, ENT_KEY
        ),
     ...
     * |   Z  |   X  |   C  |   D  |   V  |   ↓  |   ↑  |   K  |   H  |  ,<  |  .>  |  /?  |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | ____ | ____ | ____ |LWR_DE|  [{  |     ___     |  ]}  |RSE_DE| ____ | ____ | ____ |
     * `-----------------------------------------------------------------------------------'
     */
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | ____ | ____ | ____ | ____ |   (  |     SPC     | ____ | ____ | ____ | ____ | ____ | 
     * `-----------------------------------------------------------------------------------'
     */
    [_RAISE] = LAYOUT_planck_mit(
        ...
        _______, _______, _______, _______, KC_LPRN, _______, _______, _______, _______, _______, _______
        ),
    ...
    [_RAISE_DE] = LAYOUT_planck_mit(
        ...
        _______, _______, _______, _______, DE_LPRN, _______, _______, _______, _______, _______, _______
    ),
    ...
    [_LOWER] = LAYOUT_planck_mit(
        ...
        LGUI_T(KC_F1), LALT_T(KC_F2), LSFT_T(KC_F3), LCTL_T(KC_F4),  KC_F5,   KC_F6,   _______, KC_RABK,  KC_UNDS,  KC_PLUS, KC_LCBR, KC_RCBR, 
        KC_F7,   KC_F8, KC_F9,   KC_F10, KC_F11,  KC_F12,  _______, KC_PIPE, KC_GRV, KC_SCLN, KC_COLN, KC_BSLS, 
        _______, _______, _______, _______, _______, _______, KC_RPRN, _______, _______, _______, _______
        ),
    ...
    [_LOWER_DE] = LAYOUT_planck_mit(
        ...
        LGUI_T(KC_F1), LALT_T(KC_F2), LSFT_T(KC_F3), LCTL_T(KC_F4),  KC_F5,   KC_F6,   _______, DE_RABK, DE_UNDS, DE_PLUS, DE_LCBR, DE_RCBR, 
        KC_F7,   KC_F8, KC_F9,   KC_F10, KC_F11,  KC_F12,  _______,  DE_PIPE,  DE_GRV, DE_SCLN, DE_COLN, DE_BSLS, 
        _______, _______, _______, _______, _______, _______, DE_RPRN, _______, _______, _______, _______
    ),
