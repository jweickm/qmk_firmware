...
//#endif
    ...
    #if layout == 1
        #if thumb == 1
        LCTL_T(KC_CAPS), KC_LGUI, KC_LALT, LT(_NUM, KC_ESC), LOWER, NAVSPACE, RAISE, DEL_KEY, DOWN_KEY, UP_KEY, FN_KEY
        #elif thumb == 2
        LCTL_T(KC_CAPS), KC_LGUI, KC_LALT, BS_KEY, LOWER, NAVSPACE, RAISE, DEL_KEY, DOWN_KEY, UP_KEY, FN_KEY
        #endif
    #elif layout == 2
        LCTL_T(KC_CAPS), KC_LGUI, KC_LALT, LT(_NUM, KC_ESC), LOWER, NAVSPACE, RAISE, DEL_KEY, DOWN_KEY, UP_KEY, RSFT_T(KC_RALT)
    #endif
    ),
...
* _MOUSE
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | ____ | ____ | XXXX |BTN 3 |BTN 2 |    BTN 1    | LLOCK| ____ | LEFT | RIGHT| ____ | 1x2uC
     * `-----------------------------------------------------------------------------------'
     */
    ...
    #if layout == 1
        KC_TRNS, KC_TRNS, KC_NO, KC_BTN3, KC_BTN2, KC_BTN1, LLOCK, KC_TRNS, KC_LEFT, KC_RIGHT, KC_TRNS
    #elif layout == 2
        KC_TRNS, KC_TRNS, KC_NO, KC_BTN3, KC_BTN2, KC_BTN1, LLOCK, KC_TRNS, KC_LEFT, KC_RIGHT, KC_TRNS
    #endif
    ),
...
/*         QK_CLEAR_EEPROM, QK_BOOT, QK_REBOOT, RGB_TOG, AU_ON, AU_OFF, KC_NO, A(KC_GRV), LANG_SWITCH, KC_DE_SWITCH, A(KC_LSFT), KC_SLEP,*/ 
...
* _ADJUST
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |NAVSFT| XXXX |DESK<-| WHLUP| WHLDN|DESK->| HOME | PGDN | PGUP |  END | CD_SW| MPLY |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
    ...
    [_ADJUST] = LAYOUT_planck_mit(
        ...
        NAVSFT, KC_NO, C(G(KC_LEFT)), KC_WH_U, KC_WH_D, C(G(KC_RIGHT)), KC_HOME, KC_PGDN, KC_PGUP, KC_END, CODING_SW, KC_MPLY,
