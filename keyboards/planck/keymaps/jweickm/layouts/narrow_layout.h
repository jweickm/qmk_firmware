...
* _ADJUST
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |EEPRST| RESET| ____ | ____ | ____ |     ____    | ____ | MPLY | VOLD | VOLU | ____ | 1x2uC
     * `-----------------------------------------------------------------------------------'
     */
    [_ADJUST] = LAYOUT_planck_mit(
        ...
        EEPROM_RESET, RESET, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MPLY, KC_VOLD, KC_VOLU, KC_TRNS
    ),
};
